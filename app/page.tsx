      ...
      <style dangerouslySetInnerHTML={{ __html: `
        * { box-sizing: border-box; }
        ...
        .hero::after {
          ...
          pointer-events: none;
          background:
            linear-gradient(to bottom, ${theme.bg} 0%, transparent 40%),
            linear-gradient(to top, ${theme.bg} 0%, transparent 45%);
          opacity: 1;
        }
        ...
        .membership-headline { font-family: var(--font-display), sans-serif; font-size: clamp(28px, 5vw, 42px); font-weight: 700; color: white; letter-spacing: -0.02em; line-height: 1.15; margin: 0 0 16px; text-shadow: 0 0 30px rgba(${theme.accentRgb}, 0.1); }
        ...
        .experience-title { font-family: var(--font-display), sans-serif; font-size: clamp(36px, 6vw, 52px); font-weight: 800; color: white; margin: 0 0 8px; letter-spacing: -0.02em; }
        ...
        .experience-label { color: white; font-size: 16px; font-weight: 600; letter-spacing: -0.2px; }
        ...
        .final-cta h2 { margin: 0 0 12px; font-family: var(--font-display), sans-serif; font-size: clamp(32px, 5vw, 48px); font-weight: 700; color: white; letter-spacing: -0.02em; line-height: 1.1; }
